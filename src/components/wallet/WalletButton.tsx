...
export function WalletButton() {
	...
	if (!connected || !account) {
		return (
			<div className="relative" ref={dropdownRef}>
				...
				{open && (
					<div
						className="glass animate-pop-in absolute right-0 top-full z-50 mt-2 w-64 rounded-xl p-2"
						role="menu"
					>
	...
	return (
		<div className="relative" ref={dropdownRef}>
			...
			{open && (
				<div
					className="glass animate-pop-in absolute right-0 top-full z-50 mt-2 w-72 rounded-xl p-3"
					role="menu"
				>
